...
:::tip[Deep Dive]
For extensive coverage of how the insurance industry actually prices defection risk, see [Fidelity Insurance: Pricing Defection Risk](/deep-dives/research/fidelity-insurance/).
:::
