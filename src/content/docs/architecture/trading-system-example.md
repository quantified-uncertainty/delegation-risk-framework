...
- [Healthcare Triage Example](/architecture/healthcare-bot-example/) — Life-safety domain
- [Risk Budgeting Overview](/risk-budgeting/overview/) — Euler allocation for component budgets
- [Decision Guide](/implementation/decision-guide/) — When to use ML vs verified code
