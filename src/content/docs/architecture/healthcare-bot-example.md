...
- [Trading System Example](/architecture/trading-system-example/) — High-frequency, adversarial domain
- [Decision Guide](/implementation/decision-guide/) — How to choose component implementations
- [Quick Start](/implementation/quick-start/) — Apply this pattern to your domain
