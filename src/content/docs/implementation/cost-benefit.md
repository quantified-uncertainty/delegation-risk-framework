...
Based on [preliminary experiments](/implementation/empirical-tests/):
...
- [Empirical Tests](/implementation/empirical-tests/) — Experiment data behind these numbers
- [Quick Start](/implementation/quick-start/) — Begin implementation
- [Decision Guide](/implementation/decision-guide/) — Choose the right level of decomposition
