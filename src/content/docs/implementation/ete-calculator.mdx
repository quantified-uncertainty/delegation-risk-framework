...
Interactive tool for calculating Expected Trust Exposure for your AI system components.

## How to Use

1. Add failure modes for each component
2. Estimate probability and damage for each
3. Calculator computes individual and total ETE
...
<div id="ete-calculator">
  ...
  <div class="calculator-container">
    <div class="budget-input">
      <label><strong>Monthly ETE Budget: $</strong></label>
...
```
ETE = P(failure) × Damage
```

Total system ETE is the sum across all failure modes.
...
If your total ETE exceeds budget:
...
| Failure Mode | P(failure) | Damage | ETE |
|--------------|------------|--------|-----|
...
- [Quick Start](/implementation/quick-start/) — Apply ETE calculation to your system
- [Decision Guide](/implementation/decision-guide/) — Choose implementations based on ETE
