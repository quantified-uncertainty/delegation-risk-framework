...
Use the [Decision Guide](/implementation/decision-guide/) for details.
...
- [Decision Guide](/implementation/decision-guide/) — Detailed decision trees
- [Research Assistant Example](/architecture/research-assistant-example/) — Full worked example
- [Principles to Practice](/overview/principles-to-practice/) — Mapping principles to implementations
