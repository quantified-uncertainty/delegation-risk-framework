...
See [Coordinator-Specific Principles](/applying/coordinator-constraints/) for:
...
- [Research Assistant Example](/applying/examples/research-assistant-example/) — Complete worked example applying all principles
- [Code Deployment Example](/applying/examples/code-deployment-example/) — Higher-stakes example with different tradeoffs
- [Principles to Practice](/applying/principles-to-practice/) — Cross-reference mapping principles to implementations
...
- [Decision Guide](/applying/tools/decision-guide/) — Choosing implementations
