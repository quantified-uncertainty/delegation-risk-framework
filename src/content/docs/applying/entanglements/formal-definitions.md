...
Extending the [Delegation Risk formula](/framework/risk/delegation-risk-formula/):
...
For practical measurement approaches, see [Quantitative Metrics](/applying/entanglements/metrics/).

---

See also:
- [Quantitative Metrics](/applying/entanglements/metrics/) - Practical measurement of these quantities
- [Research Connections](/applying/entanglements/research-connections/) - Academic foundations
- [Types of Entanglement](/applying/entanglements/types/) - Conceptual overview
