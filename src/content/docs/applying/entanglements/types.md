...
See [Channel Integrity Patterns](/applying/patterns/channel-integrity/) for detailed detection and mitigation of regulatory capture.
...
See also:
- [Challenge Categories](/applying/entanglements/challenges/) - Sources of entanglement
- [Detecting Influence](/applying/entanglements/detecting-influence/) - Methods for detecting active entanglements
- [Modeling Approaches](/applying/entanglements/modeling/) - Quantifying entanglement
- [Solutions](/applying/entanglements/solutions/) - Reducing entanglement
