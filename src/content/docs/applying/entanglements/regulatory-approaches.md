...
See also:
- [Foundation Model Monoculture](/applying/entanglements/foundation-model-monoculture/) - The concentration problem
- [Historical Case Studies](/applying/entanglements/historical-cases/) - Regulatory failures in other domains
- [Metrics](/applying/entanglements/metrics/) - Measurement for compliance
- [Decision Framework](/applying/entanglements/decision-framework/) - When independence is worth the cost
