...
This is a core axiom of [coherent risk measures](/deep-dives/research/risk-methods/compositional-risk-measures/). It captures the intuition that combining independent systems shouldn't create extra risk.
...
**Structural Patterns:**
- [Chinese Wall](/applying/patterns/information/#chinese-wall) - Absolute information barriers
- [Separation of Powers](/applying/patterns/structural/#separation-of-powers) - No single unchecked authority
- [Bulkhead Isolation](/applying/patterns/structural/#bulkhead-isolation) - Prevent cascade failures

**Verification Patterns:**
- [Rotating Validator](/applying/patterns/verification/#rotating-validator) - Prevent verifier capture
- [Consistency Triangulation](/applying/patterns/verification/#consistency-triangulation) - Cross-reference detection

**Multi-Agent Patterns:**
- [Adversarial Collaboration](/applying/patterns/multi-agent/#adversarial-collaboration) - Requires maintained opposition
- [Trust Transitivity Limits](/applying/patterns/multi-agent/#trust-transitivity-limits) - Trust doesn't automatically propagate
