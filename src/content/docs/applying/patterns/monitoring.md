...
See also:
- [Multi-Agent Patterns](/applying/patterns/multi-agent/) - Agent interactions
- [Incentive Patterns](/applying/patterns/incentive/) - Alignment through incentives
- [Recovery Patterns](/applying/patterns/recovery/) - Handling failures
