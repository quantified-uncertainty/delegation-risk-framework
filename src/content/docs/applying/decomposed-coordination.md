...
- [Coordinator Constraints](/applying/coordinator-constraints/) — Specific principles for limiting coordinator power
- [Safety Mechanisms](/applying/safety-mechanisms/) — System-level defenses (circuit breakers, redundancy)
- [Research Assistant Example](/applying/examples/research-assistant-example/) — Full worked example of decomposed coordination
