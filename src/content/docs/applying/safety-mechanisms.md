...
- [Decomposed Coordination](/applying/decomposed-coordination/) — Architectural patterns these mechanisms protect
- [Coordinator Constraints](/applying/coordinator-constraints/) — Principles that inform mechanism design
- [Lessons from Failures](/cross-domain-methods/lessons-from-failures/) — Why these mechanisms matter
- [Code Deployment Example](/applying/examples/code-deployment-example/) — Mechanisms applied to real system
