...
- [Healthcare Triage Example](/applying/examples/healthcare-bot-example/) — Life-safety domain
- [Risk Budgeting Overview](/cross-domain-methods/overview/) — Euler allocation for component budgets
- [Decision Guide](/applying/tools/decision-guide/) — When to use ML vs verified code
