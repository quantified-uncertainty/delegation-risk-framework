...
- [Trading System Example](/applying/examples/trading-system-example/) — High-frequency, adversarial domain
- [Decision Guide](/applying/tools/decision-guide/) — How to choose component implementations
- [Quick Start](/applying/tools/quick-start/) — Apply this pattern to your domain
