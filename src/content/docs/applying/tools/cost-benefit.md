...
Based on [preliminary experiments](/applying/tools/empirical-tests/):
...
- [Empirical Tests](/applying/tools/empirical-tests/) — Experiment data behind these numbers
- [Quick Start](/applying/tools/quick-start/) — Begin implementation
- [Decision Guide](/applying/tools/decision-guide/) — Choose the right level of decomposition
