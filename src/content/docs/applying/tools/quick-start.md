...
Use the [Decision Guide](/applying/tools/decision-guide/) for details.
...
- **[Delegation Risk Calculator](/applying/tools/delegation-risk-calculator/)** — Input failure modes, get total Delegation Risk
- **[Risk Inheritance](/applying/tools/trust-propagation/)** — Compute effective trust through networks
...
- [Decision Guide](/applying/tools/decision-guide/) — Detailed decision trees
- [Research Assistant Example](/applying/examples/research-assistant-example/) — Full worked example
- [Principles to Practice](/applying/principles-to-practice/) — Mapping principles to implementations
