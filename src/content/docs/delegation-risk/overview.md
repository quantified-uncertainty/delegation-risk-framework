...
- [Risk Inheritance](/delegation-risk/trust-propagation/) - How risk flows through delegation networks
- [Delegation Interfaces & Contracts](/delegation-risk/trust-interfaces/) - Formalizing delegation relationships
- [Risk Optimization](/delegation-risk/trust-optimization/) - Minimizing delegation risk subject to capability
- [Risk Dynamics](/delegation-risk/trust-dynamics/) - How trust and risk evolve over time
- [Risk Accounting](/delegation-risk/trust-accounting/) - Ledgers, auditing, and KPIs
- [Delegation Protocols](/delegation-risk/trust-protocols/) - Handshakes, tokens, and revocation
- [Risk Economics](/delegation-risk/trust-economics/) - Insurance, arbitrage, and incentives
...
- [Risk Inheritance](/delegation-risk/trust-propagation/) — Algorithms for computing how risk flows through delegation networks
- [Risk Dynamics](/delegation-risk/trust-dynamics/) — How trust evolves, decays, and rebuilds over time

**To see delegation risk applied**:
- [Principles to Practice](/overview/principles-to-practice/) — Delegation Risk calculations for real examples
- [Risk Budgeting Overview](/risk-budgeting/overview/) — Cross-domain methods for allocating risk budgets
...
- [Decision Guide](/implementation/decision-guide/) — Choosing implementations based on risk budget
