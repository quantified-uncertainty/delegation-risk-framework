...
```
Delegation Exposure
├── Accident Exposure (non-goal-directed)
│   ├── Bugs and errors
│   ├── Hallucinations
...
│   └── System failures
│
└── Defection Exposure (goal-directed)
    ├── Scheming / deception
    ├── Pursuing misaligned objectives
...
- [Coordinator Constraints](/principles/coordinator-constraints/) — Managing defection risk in coordinators
- [Safety Mechanisms](/architecture/safety-mechanisms/) — Mitigations for both risk types
- [Glossary](/overview/glossary/) — Formal definitions
