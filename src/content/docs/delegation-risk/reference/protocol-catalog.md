...
- [Insurance Bot Specification](/delegation-risk/reference/insurance-bot-spec/) — How protocols are applied in pricing
- [Five Years Later](/delegation-risk/anomaly-chronicles/five-years-later/) — Protocol development history
- [Containing Mr. X](/delegation-risk/anomaly-chronicles/containing-mr-x/) — Original protocol design case study
