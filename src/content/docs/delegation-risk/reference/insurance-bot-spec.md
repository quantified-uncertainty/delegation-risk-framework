...
Protocol multipliers are retrieved from the Protocol Database. See [Protocol Catalog](/delegation-risk/reference/protocol-catalog/) for complete values.
...
- [Protocol Catalog](/delegation-risk/reference/protocol-catalog/) — Complete protocol reference
- [Five Years Later](/delegation-risk/anomaly-chronicles/five-years-later/) — Dynamic bidding system overview
- [Year Ten](/delegation-risk/anomaly-chronicles/year-ten/) — Current system state
