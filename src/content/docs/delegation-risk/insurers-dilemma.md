...
LEVEL 1: Established Client
├─ Coverage: 60% max
├─ Monitoring: Quarterly audits
├─ Premium: Base × 1.2
└─ Criteria: 2 years, <2 incidents, audit compliance

LEVEL 2: Trusted Client
├─ Coverage: 75% max
├─ Monitoring: Semi-annual audits
├─ Premium: Base × 1.0
└─ Criteria: 5 years, <3 incidents, proactive reporting

LEVEL 3: Partner Client
├─ Coverage: 85% max
├─ Monitoring: Annual review
├─ Premium: Base × 0.85
└─ Criteria: 10 years, <2 incidents, demonstrated excellence
```
...
- [Containing Mr. X](/delegation-risk/anomaly-chronicles/containing-mr-x/) — What Diana proposes
- [Delegation Accounting](/delegation-risk/delegation-accounting/) — The underlying framework
- [Five Years Later](/delegation-risk/anomaly-chronicles/five-years-later/) — How this scales to an industry
