...
- [Protocol Catalog](/delegation-risk/reference/protocol-catalog/) — Information containment protocols
- [Insurance Bot Specification](/delegation-risk/reference/insurance-bot-spec/) — How exposure is priced
