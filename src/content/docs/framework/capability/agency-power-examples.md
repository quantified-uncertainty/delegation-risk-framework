...
:::note[TL;DR]
This page applies the [Agency/Power formalization](/framework/capability/agent-power-formalization/) to concrete systems. We calculate Agency Scores, Power Scores, and RACAP (Risk-Adjusted Capability) for real and hypothetical systems to build intuition.
:::
