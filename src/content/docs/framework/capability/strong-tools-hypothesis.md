...
Recall from the [formalization](/framework/capability/agent-power-formalization/):
...
Concerning if this is the true relationship
```
...
```
Scenario A (Optimistic):           Scenario B (Pessimistic):
Strong tools achievable            Agency required for capability
...
Strong tools = staying on the       No path to high capability
flat part of the frontier           without high agency
```
...
│             │ │             │ │             │
│ Low agency  │ │ Low agency  │ │ Low agency  │
└─────────────┘ └─────────────┘ └─────────────┘
```
...
1. **[Formalizing Agents, Power, and Authority](/framework/capability/agent-power-formalization/)** — The theoretical framework
2. **[Worked Examples: Agency and Power](/framework/capability/agency-power-examples/)** — Concrete calculations
3. **The Strong Tools Hypothesis** ← You are here

Now continue to the **Risk Formalization** series:

4. **[Delegation Risk Overview](/framework/risk/overview/)** — The formula for quantifying risk
5. **[A Walk-Through](/framework/risk/walkthrough/)** — Complete worked example

## See Also

- [Research Projects #32](/deep-dives/research/potential-projects/#32-the-strong-tools-hypothesis) — Research agenda for testing this hypothesis
