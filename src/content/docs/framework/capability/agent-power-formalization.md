...
2. **[Worked Examples: Agency and Power](/framework/capability/agency-power-examples/)** — Calculate Agency Scores, Power Scores, and RACAP for real systems
3. **[The Strong Tools Hypothesis](/framework/capability/strong-tools-hypothesis/)** — Can we get high capability with low agency?
...
- [Risk Decomposition](/framework/risk/risk-decomposition/) — Accident vs. defection risk
- [Least X Principles](/applying/least-x-principles/) — Constraining power and agency
- [Trust Dynamics](/deep-dives/theory/trust-dynamics/) — How trust and authority evolve
