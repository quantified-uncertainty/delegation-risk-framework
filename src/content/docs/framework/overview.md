...
- [Risk Dynamics](/deep-dives/theory/trust-dynamics/) - How trust and risk evolve over time
- [Risk Accounting](/deep-dives/theory/trust-accounting/) - Ledgers, auditing, and KPIs
- [Delegation Protocols](/deep-dives/theory/trust-protocols/) - Handshakes, tokens, and revocation
- [Risk Economics](/deep-dives/theory/trust-economics/) - Insurance, arbitrage, and incentives
- [Delegation at Scale](/deep-dives/theory/trust-at-scale/) - Distributed systems and bottlenecks
- [Human-AI Delegation](/deep-dives/theory/human-ai-trust/) - Team dynamics and calibration
...
- [Risk Inheritance](/deep-dives/theory/trust-propagation/) — Algorithms for computing how risk flows through delegation networks
- [Risk Dynamics](/deep-dives/theory/trust-dynamics/) — How trust evolves, decays, and rebuilds over time

**To see delegation risk applied**:
- [Principles to Practice](/applying/principles-to-practice/) — Delegation Risk calculations for real examples
...
- [Background Research](/deep-dives/research/) — Deep dives into nuclear, aerospace, and financial risk methods

**To start implementing**:
- [Quick Start](/applying/tools/quick-start/) — Step-by-step application checklist
- [Decision Guide](/applying/tools/decision-guide/) — Choosing implementations based on risk budget
