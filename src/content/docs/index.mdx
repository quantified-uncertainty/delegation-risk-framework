...
<CardGrid>
  ...
  <Card title="Principles that Bound Behavior" icon="list-format">
    The ["Least X" principles](/principles/least-x-principles/)—least privilege, least capability, least context—systematically limit what each component can do.
  </Card>
  <Card title="Cross-Domain Wisdom" icon="open-book">
    Nuclear safety, financial risk, and mechanism design have decades of experience. We adapt their [proven methods](/risk-budgeting/overview/) to delegation problems.
  </Card>
</CardGrid>
...
<CardGrid>
  <Card title="5-Minute Introduction" icon="rocket">
    Short on time? Get the core ideas in one page. [Read the 5-minute intro →](/overview/five-minute-intro/)
  </Card>
  <Card title="Ready to Implement?" icon="laptop">
    Step-by-step checklist for applying the framework. [Quick Start →](/implementation/quick-start/)
  </Card>
  <Card title="Have Questions?" icon="information">
    Common objections answered. [Read the FAQ →](/overview/faq/)
  </Card>
  <Card title="Evaluate the ROI" icon="seti:notebook">
    Concrete cost-benefit analysis with real numbers. [See the analysis →](/implementation/cost-benefit/)
  </Card>
</CardGrid>
...
- **[Sydney (Failure)](/overview/case-study-sydney/)** — What happens when constraints are missing
- **[Code Review Bot (Success)](/overview/case-study-success/)** — 8 months in production, 12 attacks blocked
- **[Support Bot (Near-Miss)](/overview/case-study-near-miss/)** — $50,000 error caught by verification
- **[Content Moderator (Drift)](/overview/case-study-drift/)** — How small changes compound into big problems
...
3. **[Design Principles](/principles/least-x-principles/)** — Actionable constraints

**Interactive Tools**: [Delegation Risk Calculator](/implementation/delegation-risk-calculator/) · [Risk Inheritance](/implementation/trust-propagation/) · [Tradeoff Frontier](/implementation/tradeoff-frontier/)
