...
- **Apply to AI systems** → [The Insurer's Dilemma](/framework/insurers-dilemma/) shows these principles in action
- **See worked examples** → [Delegation Accounting](/framework/delegation-accounting/) uses similar incentive structures
