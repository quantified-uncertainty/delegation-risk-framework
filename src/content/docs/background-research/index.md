...
### [Nuclear & Aerospace PRA: Deep Dive](/background-research/nuclear-aerospace-deep-dive/)
...
**Relevance to framework**: The [Risk Budgeting](/risk-budgeting/overview/) section adapts these methods for AI systems. Understanding the original domain helps you apply them correctly.

### [Financial Risk Budgeting](/background-research/financial-risk-budgeting/)
...
**Relevance to framework**: The [Implementation Roadmap](/implementation/roadmap/) references these projects as next steps.

## Reading Guide

**If you're implementing the framework**: You probably don't need this section initially. Start with [Core Concepts](/overview/core-concepts/) and the worked examples.
...
**If you're validating the framework**: The [Potential Research Projects](/background-research/potential-projects/) page lists specific experiments that would strengthen or challenge the framework's assumptions.
...
- [Risk Budgeting Overview](/risk-budgeting/overview/) — How we apply these methods
- [Empirical Tests](/implementation/empirical-tests/) — Testable predictions from the framework
- [Glossary](/overview/glossary/) — Definitions of domain-specific terms
