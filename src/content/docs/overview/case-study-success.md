...
- [Case Study: Sydney](/overview/case-study-sydney/) — Failure case analysis
- [Case Study: Near-Miss](/overview/case-study-near-miss/) — Incident caught before damage
- [Research Assistant Example](/architecture/research-assistant-example/) — Full architecture walkthrough
- [Safety Mechanisms](/architecture/safety-mechanisms/) — Detailed safety patterns
