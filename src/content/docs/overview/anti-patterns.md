...
**Do instead**: Apply Principle of Least Intelligence. Use the [Implementation Decision Tree](/principles/least-x-principles/#implementation-decision-tree). Default to code; only use LLMs when judgment/creativity required.
...
- [Least X Principles](/principles/least-x-principles/) — The positive counterpart to these anti-patterns
- [Safety Mechanisms](/architecture/safety-mechanisms/) — How to implement proper defenses
- [Quick Start](/implementation/quick-start/) — Checklist for doing it right
- [Lessons from Failures](/risk-budgeting/lessons-from-failures/) — Historical examples of anti-patterns causing harm
