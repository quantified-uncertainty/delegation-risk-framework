...
- [Anti-patterns](/overview/anti-patterns/) — Sydney violated many of these
- [Least X Principles](/principles/least-x-principles/) — The positive guidance Sydney lacked
- [Decomposed Coordination](/architecture/decomposed-coordination/) — Alternative architecture
- [Safety Mechanisms](/architecture/safety-mechanisms/) — Circuit breakers and tripwires
