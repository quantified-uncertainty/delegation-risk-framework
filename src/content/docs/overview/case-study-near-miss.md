...
- [Case Study: Sydney](/overview/case-study-sydney/) — What happens when verification fails
- [Case Study: Code Review Bot](/overview/case-study-success/) — Sustained success over time
- [Safety Mechanisms](/architecture/safety-mechanisms/) — Verification layer patterns
- [Lessons from Failures](/risk-budgeting/lessons-from-failures/) — Pattern analysis
