...
1. [Core Concepts](/overview/core-concepts/) — Key ideas without mathematical formalism
2. [Delegation Risk Overview](/delegation-risk/overview/) — The quantitative foundation
3. [Least X Principles](/principles/least-x-principles/) — Actionable design constraints
:::
